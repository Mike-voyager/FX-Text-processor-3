...
# Try import BLAKE3
try:
    from .blake3_hash import compute_hash_blake3, blake3_hash_file, BLAKE3_AVAILABLE
except ImportError:
    BLAKE3_AVAILABLE = False
    compute_hash_blake3 = None
    blake3_hash_file = None
...
def hash_file(filepath: str, algorithm: str = "sha3-256", chunk_size: int = 1024*1024) -> str:
    """
